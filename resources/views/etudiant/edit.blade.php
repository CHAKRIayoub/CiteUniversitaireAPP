...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        <div class="title_left">
            <h3>Modification de votre Dossier</h3> 
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1 ">
            ...
            <form id="form" class="form-horizontal form-label-left" method="POST" action="{{ route('dossier.update', Auth::user()->dossier->id ) }}">
                    ...
                    <div class="panel-body" ><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" style="margin-left: 20px;" >
                                <label class="radio">
                                    <input @if(Auth::user()->dossier->genre == "masculin" ) checked @endif  type="radio" name="genre" value="masculin">
                                    Masculin
                                </label>
                              
                                <label class="radio">
                                    <input @if(Auth::user()->dossier->genre == "feminin" ) checked @endif type="radio" name="genre"  value="feminin" >
                                    feminin
                                </label>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" style="margin-left: 20px;" >
                                <label class="radio">
                                    <input @if(Auth::user()->dossier->handicape == "oui" ) checked @endif  type="radio" name="handicape" value="oui">
                                    oui
                                </label>
                              
                                <label class="radio">
                                    <input @if(Auth::user()->dossier->handicape == "non" ) checked @endif type="radio" name="handicape"  value="non" >
                                    non
                                </label>
                            </div>
                        </div><br>
  						 ...
  						 <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" style="margin-left: 20px;" >
                                <label class="radio">
                                    <input @if(Auth::user()->dossier->maladie == "oui" ) checked @endif type="radio" name="maladie" value="oui">
                                    oui
                                </label>
                              
                                <label class="radio">
                                    <input @if(Auth::user()->dossier->maladie == "non" ) checked @endif type="radio" name="maladie"  value="non" >
                                    non
                                </label>
                            </div>
                        </div><br><br><br>
			  	...
			  	<div class="panel panel-success">    
                    ...
                    <div class="panel-body" ><br>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select v-model="mention" class="form-control" name="mention">
 				...
 				<div class="panel panel-success">    
                    ...
                    <div class="panel-body" ><br>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
	                        ...
	                        <select v-model="etablissement"  class="form-control" name="etablissement"  >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <!-- _________________ universite Input _______________ -->
                           	<select v-model="cycle"  class="form-control" name="cycle">
...
<script type="text/javascript">
    ...
    new Vue({  
        ...
        data() {
            return{
	            cne:'{{ Auth::user()->dossier->cne }}',
				cin:'{{ Auth::user()->dossier->cin }}',
				lieu_naissance:'{{ Auth::user()->dossier->lieu_naissance }}',
				date_naissance:'{{ Auth::user()->dossier->date_naissance }}',
				nom:'{{ Auth::user()->dossier->nom }}',
				prenom:'{{ Auth::user()->dossier->prenom }}',
				adresse:'{{ Auth::user()->dossier->adresse }}',
				ville:'{{ Auth::user()->dossier->ville_id }}',
				telephone:'{{ Auth::user()->dossier->telephone }}',
				annee_bac:'{{ Auth::user()->dossier->annee_bac }}',
				mention:'{{ Auth::user()->dossier->mention }}',
				etablissement:'{{ Auth::user()->dossier->etablissement }}',
				nom_pere:'{{ Auth::user()->dossier->nom_pere }}',
				cin_pere:'{{ Auth::user()->dossier->cin_pere }}',
				nom_mere:'{{ Auth::user()->dossier->nom_mere }}',
				cin_mere:'{{ Auth::user()->dossier->cin_mere }}',
				revenue:'{{ Auth::user()->dossier->revenue }}',
				nb_enfants:'{{ Auth::user()->dossier->nb_enfants }}',
                cycle:'{{ Auth::user()->dossier->cycle }}',
                chargement: true
            }
        },
        methods: {
